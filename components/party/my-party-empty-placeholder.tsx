...
interface MyPartyEmptyPlaceholderProps {
    dialogHandler: (state: boolean) => void;
}

export function MyPartyEmptyPlaceholder({ dialogHandler }: MyPartyEmptyPlaceholderProps) {
    return (
        <div className="flex h-[450px] shrink-0 items-center justify-center rounded-md border border-dashed">
            <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
                <svg
                    ...
                    className="h-14 w-14  fill-gray-400"
                    viewBox="0 0 300.948 300.948"
                >
                    <g id="XMLID_1505_">
                        <g>
                            <g>
                ...
                <h3 className="mt-4 text-lg font-semibold">Nenhuma festa adicionada</h3>
                <p className="mb-4 mt-2 text-sm text-muted-foreground">
                    Você não adicionou nenhuma festa. Adicione uma abaixo.
                </p>
                <Button size="sm" className="relative" onClick={() => {
                    dialogHandler(true)
                }}>
                    Adicionar Festa
                </Button>
